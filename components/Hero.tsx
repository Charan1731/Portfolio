        ...
        <div className='flex justify-center relative my-20 z-10'>
            <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                <div className="px-4 py-1 bg-purple/10 rounded-full mb-4 backdrop-blur-sm border border-purple/20">
                    <h2 className='uppercase tracking-widest text-xs text-center text-purple'>Crafting dynamic sites with Next.js</h2>
                </div>
                <TextGenerateEffect 
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center">
                    ...
                    <div className="flex gap-4 mt-4 sm:mt-2">
                        <a href="https://github.com/Charan1731" target="_blank" className="text-gray-400 hover:text-white transition-colors">
                            <FaGithub size={24} />
                        </a>
                        <a href="https://www.linkedin.com/in/charandeep-reddy-2640a4301/" target="_blank" className="text-gray-400 hover:text-white transition-colors">
                            <FaLinkedin size={24} />
                        </a>
                        <a href="https://x.com/CharanR18433412" target="_blank" className="text-gray-400 hover:text-white transition-colors">
                            <FaTwitter size={24} />
                        </a>
                    </div>
                </div>
