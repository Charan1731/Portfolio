              ...
              <div key={id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem flex items-center justify-center sm:w-[570px] w-[90vw]'>
                <PinContainer title="visit" href={link}>
                  <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh] mb-10'>
                    ...
                    <Image src={img} alt="cover" className='z-10 absolute bottom-0' height={500} width={500} />
                  </div>
                  ...
                  <div className='flex items-center justify-between mt-7 mb-3'>
                    <div className='flex items-center'>
                      {iconLists.map((icon, index) => (
                        <div key={icon} className='border border-white/[0.2] rounded-full lg:w-10 lg:h-10 w-8 h-8 flex justify-center items-center' style={{ transform: `translateX(-${5 * index * 2}px)` }}>
