...
export const BentoGridItem = ({
  ...
  const leftLists = ["Rust", "Solana", "AWS"];
  const rightLists = ["Quantum", "NextJS", "Jenkins"];
  ...
  const handleCopy = () => {
    const text = "charan23114@gmail.com";
  ...
  return (
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full w-full relative`}>
        ...
        {spareImg && (
          <div className={`absolute right-0 bottom-0 z-0 ${id === 5 && "w-full opacity-80"}`}>
            <Image
              src={spareImg}
              alt={spareImg}
              width={200}
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2 z-20">
